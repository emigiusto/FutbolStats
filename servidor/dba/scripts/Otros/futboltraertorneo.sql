...
left outer join (select player.id, jugadorresultado.resultado, count(jugadorresultado.resultado) as 'ganados' from player join jugadorresultado on player.id = jugadorresultado.jugador_id join partidotorneo on partidotorneo.partido_id = jugadorresultado.partido_id where jugadorresultado.resultado = 1 and partidotorneo.torneo_id =4 group by player.id, jugadorresultado.resultado) as TW on player.id = TW.id 

left outer join (select player.id, jugadorresultado.resultado, count(jugadorresultado.resultado) as 'perdidos' from player join jugadorresultado on player.id = jugadorresultado.jugador_id join partidotorneo on partidotorneo.partido_id = jugadorresultado.partido_id where jugadorresultado.resultado = 0 and partidotorneo.torneo_id = 4 group by player.id, jugadorresultado.resultado) as TL on player.id = TL.id 

left outer join (select player.id, jugadorresultado.resultado, count(jugadorresultado.resultado) as 'empatados' from player join jugadorresultado on player.id = jugadorresultado.jugador_id join partidotorneo on partidotorneo.partido_id = jugadorresultado.partido_id where jugadorresultado.resultado = 2 and partidotorneo.torneo_id = 4 group by player.id, jugadorresultado.resultado) as TE on player.id = TE.id 



left outer join (select player.id, jugadorresultado.resultado, SUM(partidos.puntosganador) as 'puntosfavorganador', SUM(partidos.puntosperdedor) as 'puntoscontraganador' from player join jugadorresultado on player.id = jugadorresultado.jugador_id join partidotorneo on partidotorneo.partido_id = jugadorresultado.partido_id JOIN partidos on  partidotorneo.partido_id = partidos.id where jugadorresultado.resultado = 1 and partidotorneo.torneo_id = 4 group by player.id, jugadorresultado.resultado) as TPG on player.id = TPG.id 
left outer join (select player.id, jugadorresultado.resultado, SUM(partidos.puntosperdedor) as 'puntosfavorperdedor', SUM(partidos.puntosganador) as 'puntoscontraperdedor' from player join jugadorresultado on player.id = jugadorresultado.jugador_id join partidotorneo on partidotorneo.partido_id = jugadorresultado.partido_id JOIN partidos on  partidotorneo.partido_id = partidos.id where jugadorresultado.resultado = 0 and partidotorneo.torneo_id = 4 group by player.id, jugadorresultado.resultado) as TPP on player.id = TPP.id 
...
join (select player.id as 'idplayer',
		...
		TW.ganadosalltime, TL.perdidosalltime, TW.ganadosalltime/(TW.ganadosalltime+TL.perdidosalltime) as 'eficienciaAlltime',
		((TW.ganadosalltime+TL.perdidosalltime)/(partidostotalestodos.total)) as 'asistenciaAllTime' 
	from player 
    ...
    join (select player.id, ((SUM(case when jugadorresultado.resultado = 0 then partidos.puntosperdedor else partidos.puntosganador end))/(COUNT(jugadorresultado.resultado))) as 		'puntosfavorporpartido' from player join jugadorresultado on player.id = jugadorresultado.jugador_id join partidos on jugadorresultado.partido_id = partidos.id group by 		player.id) as TPF on player.id = TPF.id  
    join (select player.id, ((SUM(case when jugadorresultado.resultado = 1 then partidos.puntosperdedor else partidos.puntosganador end))/(COUNT(jugadorresultado.resultado))) as 		'puntoscontraporpartido' from player join jugadorresultado on player.id = jugadorresultado.jugador_id join partidos on jugadorresultado.partido_id = partidos.id group by 		player.id) as TPC on player.id = TPC.id 
    group by player.id)
as table1 on player.id = table1.idplayer 

where torneos.id= 4 group by player.id order by eficiencia desc;